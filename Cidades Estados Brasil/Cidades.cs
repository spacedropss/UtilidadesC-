...
namespace Utilidades
{
    public class Cidade
    {
        ...
        private string[] cidadesBrasil;

        /// <summary>
        /// Lê a UF e retorna um vetor de Cidades
        /// </summary>
        /// <param name="uf"></param>
        /// <returns></returns>
        public string[] GetCidades(string uf)
        {
            MethodInfo method = this.GetType().GetMethod(uf);
        ...
        public string[] AL()
        {
            cidadesBrasil = new string[]
            {
                ...
                "Coqueiro Seco", "Coruripe", "Craíbas","Delmiro Gouveia", "Dois Riachos",
                "Estrela de Alagoas",
                ...
                "Maribondo", "Mata Grande", "Matriz de Camaragibe", "Messias", "Minador do Negrão","Monteirópolis", "Murici",
                "Novo Lino",
                ...
                "Tanque dArca", "Taquarana", "Teotônio Vilela", "Traipu","União dos Palmares","Viçosa"
            };
            return cidadesBrasil;
        }       
        public string[] AP()
        {
            cidadesBrasil = new string[]
